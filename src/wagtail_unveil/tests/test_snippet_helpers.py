...
class SnippetHelperTests(TestCase):
    ...
    def test_snippet_urls_with_instances(self, mock_get_instance_sample, mock_model_has_instances, mock_get_for_model, mock_get_snippet_models):
        ...
        self.assertIn(("app1.model1 (Instance 1)", "Instance 1", "edit", "http://testserver/admin/snippets/app1/model1/1/"), result)
        self.assertIn(("app1.model1 (Instance 2)", "Instance 2", "edit", "http://testserver/admin/snippets/app1/model1/2/"), result)
        
        # Check delete URLs for instances
        self.assertIn(("app1.model1 (Instance 1)", "Instance 1", "delete", "http://testserver/admin/snippets/app1/model1/1/delete/"), result)
        self.assertIn(("app1.model1 (Instance 2)", "Instance 2", "delete", "http://testserver/admin/snippets/app1/model1/2/delete/"), result)
